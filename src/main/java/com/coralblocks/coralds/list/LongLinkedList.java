...
public class LongLinkedList implements Iterable<LongHolder> {
	...
	/**
	 * Compares this list with another LongLinkedList by value and order.
	 *
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof LongLinkedList)) return false;

		LongLinkedList other = (LongLinkedList) o;
